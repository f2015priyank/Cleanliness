...
<?php include("header.php")?>
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<div class="container">
					...
					<br>
					<br>
					<h3><font color="gold"><b>Welcome to the swachhata Platform</b></font></h3>
						<font color="black"><h4><b>An initiative of the Swachh UTU Mission in association with <br>UKA TARSADIA UNIVERSITY.</b></h4></font>
					</div>
				</div>
			</div>
	...
	<h3 class="heading-agileinfo">Welcome To UTU!<span>We offer extensive medical procedures to outbound and inbound patients.</span></h3>
		<div class="container">
			<div class="w3-flex">
...
<div class="emergency_cases_bt">
	...
	<div class="emergency_cases_top">
		<div class="col-md-6 emergency_cases_w3ls_left">
			<h4>Complaint Time</h4>
			<h6>User Can register a complaint 24*7 working days.</h6>
		</div>
		<div class="col-md-6 emergency_cases_w3ls_right">
			<h4>Official Email and Numbers</h4>
			<h4><i class="fa fa-phone" aria-hidden="true"></i><font color="white">+(91) 2625 290020<br>&nbsp;&nbsp;&nbsp;&nbsp; +(91) 2625 290074</font></h4>
			<p>Email:- ceo@utu.ac.in, cleanutu@gmail.com.</p>
		</div>
