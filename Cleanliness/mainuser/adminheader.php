            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="newcomplaints.php"><i class="fa fa-angle-right"></i>New Complaints</a></li>
				  <li><a href="#"><i class="fa fa-angle-right"></i>Closed Complaints</a></li>
                </ul>
              </li>
			  <li class="treeview">
                <a href="createcoordinator.php">
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									...
									<div class="user-name">
										<p><?php echo "Welcome  $_SESSION[LoggedName]";?></p>
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li> <a href="adminchangepassword.php"><i class="fa fa-cog"></i>Change Password</a> </li> 
